...
// 	
	...
	if (session_end_date == null){
		...
		if (pathname == '/bulk/summary' || pathname == '/advancedsearchistory'){
...
function genLineChart(greenDataIndex, orangeDataIndex){
	...
	if(greenDataIndex=='ctr' || greenDataIndex=='conversion_rate' || greenDataIndex=='cost' || greenDataIndex=='avg_cpc' || greenDataIndex=='cpa' || greenDataIndex=='revenue' || greenDataIndex=='profit' || greenDataIndex=='avg_pos'){
		gotDecimal = true;
	}
	
	if(orangeDataIndex=='ctr' || orangeDataIndex=='conversion_rate' || orangeDataIndex=='cost' || orangeDataIndex=='avg_cpc' || orangeDataIndex=='cpa' || orangeDataIndex=='revenue' || orangeDataIndex=='profit' || orangeDataIndex=='avg_pos'){
		gotDecimal = true;
	}
